...
import static kaka.BasicMod.characterPath;
...
public class MyCharacter extends CustomPlayer {
    ...
    public static final int STARTING_GOLD = 1;
    public static final int CARD_DRAW = 5;
    public static final int ORB_SLOTS = 0;

    //Strings
    private static final String ID = makeID("kaka"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass Tata;
